 ...
 * @version  $Id: NusoapServer.php,v 1.63 2010/04/26 20:15:08 snichol Exp $
 * @access   public
 */
class Server extends NuSoap
{
    /**
...
//        global $HTTP_SERVER_VARS;
    ...
    public function serialize_return()
    {
        ...
        // if fault
        if (isset($this->methodreturn) && is_object($this->methodreturn) && ((get_class($this->methodreturn) == 'soap_fault') || (get_class($this->methodreturn) == 'Fault'))) {
